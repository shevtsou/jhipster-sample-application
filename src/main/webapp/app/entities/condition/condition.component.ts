...
export class ConditionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.conditionService
            ...
            .subscribe(
                (res: HttpResponse<ICondition[]>) => this.paginateConditions(res.body, res.headers),
    ...
    trackId(index: number, item: ICondition) {
        return item.id;
    }
    ...
    protected paginateConditions(data: ICondition[], headers: HttpHeaders) {
